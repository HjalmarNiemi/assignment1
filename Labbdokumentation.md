...
Även en säkerhetsbrist som kan resultera i katastrofala konsekvenser i skarp miljö som AI-vertyget missade att förklara var att användningen av flaggan `-R` kan göra att en grupp eller användare kan få behörighet till hela systemet, viktiga systemfiler förlorar korrekta grupprättigheter och systemtjänster slutar fungera om det skulle användas på root /. Ett exempel på detta skulle kunna vara där man råkar ha ett mellanslag efter / och innan praktikanter:    
